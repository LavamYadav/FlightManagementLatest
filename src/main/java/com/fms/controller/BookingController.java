...
public class BookingController {
	...
	private List<Booking> getBookingbyUserId(@PathVariable("userId") int userId ){
	...
	private Booking saveBooking(@RequestBody Booking booking) 
	{
		return bookingService.addBooking(booking);
	}
	
	@PutMapping("/modify")
	private ResponseEntity<?> modifyBooking(@RequestBody Booking booking) {
	...
	private boolean cancelBooking(@PathVariable("bookingId") int bookingId) {
